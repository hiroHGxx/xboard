...
const getUserIdsByUsernames = async (usernames: string[], bearerToken: string): Promise<{[username: string]: string}> => {
...
const getTweetsFromAPI = async (usernamesOrIds: string[], limit: number): Promise<Tweet[]> => {
...
const getMockTweets = (limit: number): Tweet[] => {
